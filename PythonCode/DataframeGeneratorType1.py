...
input_folder_path = r'C:\Users\Wesley\Desktop\TCC_Project\MIT-BIH_Arrhythmia_Database\Type_1'

# Caminho para o arquivo de saída
output_file_path = r'C:\Users\Wesley\Desktop\TCC_Project\MIT-BIH_Arrhythmia_Database\Dataframe_Type_1.csv'

# Inicializar uma lista para armazenar os dados MLII de todos os arquivos
ml2_data_list = []

# Iterar sobre todos os arquivos na pasta Type_1
for file_name in os.listdir(input_folder_path):
    if file_name.endswith('.csv'):
        ...
        # Converter os dados da coluna MLII em uma única linha separada por vírgula e adicionar '1.0' no final
        ml2_data = ','.join(map(str, df['MLII'].values.tolist())) + ',1.0'
